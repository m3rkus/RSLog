#
#  Be sure to run `pod spec lint RSLog.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "m3rkus"
  # s.authors            = { "m3rkus" => "roma4271@gmail.com" }
  # s.social_media_url   = "http://twitter.com/m3rkus"
